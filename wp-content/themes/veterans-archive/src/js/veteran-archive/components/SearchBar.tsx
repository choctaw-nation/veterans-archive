...
export default function SearchBar( { searchTerm, setSearchTerm, children } ) {
	return (
		<form className="col" action="/veterans">
			...
			<div className="row align-items-center row-gap-2">
				<div className="col-lg-auto flex-grow-1">
					<input
						...
						placeholder="Try searching by name, conflict, branch, or more"
					/>
				</div>
			...
			<div className="row my-3">{ children }</div>
		</form>
	);
}
